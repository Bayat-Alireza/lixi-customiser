...
export const SearchPath: React.FC = () => {
  ...
  return (
    <div>
      <div >
        {showSearchBox? 
        <Slide direction="down" in={showSearchBox} mountOnEnter unmountOnExit {...(showSearchBox ? { timeout: 500 } : {})}>
          <Paper className={classes.root}>
            ...
            : <IconBreadcrumbs iconClickHandler={()=>setShowSearchBox(true)} pathSections={path?.split(".")} />}
      </div>
    </div>
  );
};
